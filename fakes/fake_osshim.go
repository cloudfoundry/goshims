...
func (fake *Os) FindProcess(pid int) (*os.Process, error) {
...
func (fake *Os) FindProcessCallCount() int {
	fake.findProcessMutex.RLock()
	defer fake.findProcessMutex.RUnlock()
	return len(fake.findProcessArgsForCall)
}

func (fake *Os) FindProcessArgsForCall(i int) int {
	fake.findProcessMutex.RLock()
	defer fake.findProcessMutex.RUnlock()
	return fake.findProcessArgsForCall[i].pid
}

func (fake *Os) FindProcessReturns(result1 *os.Process, result2 error) {
...
func (fake *Os) StartProcess(name string, argv []string, attr *os.ProcAttr) (*os.Process, error) {
	var argvCopy []string
	if argv != nil {
...
func (fake *Os) Hostname() (name string, err error) {
...
func (fake *Os) HostnameCallCount() int {
	fake.hostnameMutex.RLock()
	defer fake.hostnameMutex.RUnlock()
	return len(fake.hostnameArgsForCall)
}

func (fake *Os) HostnameReturns(result1 string, result2 error) {
...
func (fake *Os) Expand(s string, mapping func(string) string) string {
...
func (fake *Os) ExpandEnv(s string) string {
...
func (fake *Os) Getenv(key string) string {
...
func (fake *Os) LookupEnv(key string) (string, bool) {
...
func (fake *Os) LookupEnvCallCount() int {
	fake.lookupEnvMutex.RLock()
	defer fake.lookupEnvMutex.RUnlock()
	return len(fake.lookupEnvArgsForCall)
}

func (fake *Os) LookupEnvArgsForCall(i int) string {
	fake.lookupEnvMutex.RLock()
	defer fake.lookupEnvMutex.RUnlock()
	return fake.lookupEnvArgsForCall[i].key
}

func (fake *Os) LookupEnvReturns(result1 string, result2 bool) {
...
func (fake *Os) Setenv(key string, value string) error {
...
func (fake *Os) SetenvCallCount() int {
	fake.setenvMutex.RLock()
	defer fake.setenvMutex.RUnlock()
	return len(fake.setenvArgsForCall)
}

func (fake *Os) SetenvArgsForCall(i int) (string, string) {
	fake.setenvMutex.RLock()
	defer fake.setenvMutex.RUnlock()
	return fake.setenvArgsForCall[i].key, fake.setenvArgsForCall[i].value
}

func (fake *Os) SetenvReturns(result1 error) {
	fake.SetenvStub = nil
...
func (fake *Os) Unsetenv(key string) error {
...
func (fake *Os) NewSyscallError(syscall string, err error) error {
...
func (fake *Os) IsExist(err error) bool {
...
func (fake *Os) IsNotExist(err error) bool {
...
func (fake *Os) IsPermission(err error) bool {
...
func (fake *Os) Mkdir(name string, perm os.FileMode) error {
...
func (fake *Os) Chdir(dir string) error {
...
func (fake *Os) Open(name string) (*os.File, error) {
	fake.openMutex.Lock()
...
func (fake *Os) OpenCallCount() int {
	fake.openMutex.RLock()
	defer fake.openMutex.RUnlock()
	return len(fake.openArgsForCall)
}

func (fake *Os) OpenArgsForCall(i int) string {
	fake.openMutex.RLock()
	defer fake.openMutex.RUnlock()
	return fake.openArgsForCall[i].name
}

func (fake *Os) OpenReturns(result1 *os.File, result2 error) {
	fake.OpenStub = nil
...
func (fake *Os) Create(name string) (*os.File, error) {
...
func (fake *Os) CreateCallCount() int {
	fake.createMutex.RLock()
	defer fake.createMutex.RUnlock()
	return len(fake.createArgsForCall)
}

func (fake *Os) CreateArgsForCall(i int) string {
	fake.createMutex.RLock()
	defer fake.createMutex.RUnlock()
	return fake.createArgsForCall[i].name
}

func (fake *Os) CreateReturns(result1 *os.File, result2 error) {
	fake.CreateStub = nil
...
func (fake *Os) Rename(oldpath string, newpath string) error {
...
func (fake *Os) RenameCallCount() int {
	fake.renameMutex.RLock()
	defer fake.renameMutex.RUnlock()
	return len(fake.renameArgsForCall)
}

func (fake *Os) RenameArgsForCall(i int) (string, string) {
	fake.renameMutex.RLock()
	defer fake.renameMutex.RUnlock()
	return fake.renameArgsForCall[i].oldpath, fake.renameArgsForCall[i].newpath
}

func (fake *Os) RenameReturns(result1 error) {
	fake.RenameStub = nil
...
func (fake *Os) NewFile(fd uintptr, name string) *os.File {
...
func (fake *Os) OpenFile(name string, flag int, perm os.FileMode) (*os.File, error) {
...
func (fake *Os) Truncate(name string, size int64) error {
...
func (fake *Os) Remove(name string) error {
...
func (fake *Os) RemoveCallCount() int {
	fake.removeMutex.RLock()
	defer fake.removeMutex.RUnlock()
	return len(fake.removeArgsForCall)
}

func (fake *Os) RemoveArgsForCall(i int) string {
	fake.removeMutex.RLock()
	defer fake.removeMutex.RUnlock()
	return fake.removeArgsForCall[i].name
}

func (fake *Os) RemoveReturns(result1 error) {
	fake.RemoveStub = nil
...
func (fake *Os) Chmod(name string, mode os.FileMode) error {
...
func (fake *Os) Chtimes(name string, atime time.Time, mtime time.Time) error {
...
func (fake *Os) Pipe() (r *os.File, w *os.File, err error) {
	fake.pipeMutex.Lock()
...
func (fake *Os) PipeCallCount() int {
	fake.pipeMutex.RLock()
	defer fake.pipeMutex.RUnlock()
	return len(fake.pipeArgsForCall)
}

func (fake *Os) PipeReturns(result1 *os.File, result2 *os.File, result3 error) {
	fake.PipeStub = nil
...
func (fake *Os) Link(oldname string, newname string) error {
	fake.linkMutex.Lock()
...
func (fake *Os) Symlink(oldname string, newname string) error {
...
func (fake *Os) Readlink(name string) (string, error) {
...
func (fake *Os) ReadlinkCallCount() int {
	fake.readlinkMutex.RLock()
	defer fake.readlinkMutex.RUnlock()
	return len(fake.readlinkArgsForCall)
}

func (fake *Os) ReadlinkArgsForCall(i int) string {
	fake.readlinkMutex.RLock()
	defer fake.readlinkMutex.RUnlock()
	return fake.readlinkArgsForCall[i].name
}

func (fake *Os) ReadlinkReturns(result1 string, result2 error) {
...
func (fake *Os) Chown(name string, uid int, gid int) error {
...
func (fake *Os) Lchown(name string, uid int, gid int) error {
...
func (fake *Os) Stat(name string) (os.FileInfo, error) {
	fake.statMutex.Lock()
...
func (fake *Os) StatCallCount() int {
	fake.statMutex.RLock()
	defer fake.statMutex.RUnlock()
	return len(fake.statArgsForCall)
}

func (fake *Os) StatArgsForCall(i int) string {
	fake.statMutex.RLock()
	defer fake.statMutex.RUnlock()
	return fake.statArgsForCall[i].name
}

func (fake *Os) StatReturns(result1 os.FileInfo, result2 error) {
	fake.StatStub = nil
...
func (fake *Os) Lstat(name string) (os.FileInfo, error) {
...
func (fake *Os) LstatCallCount() int {
	fake.lstatMutex.RLock()
	defer fake.lstatMutex.RUnlock()
	return len(fake.lstatArgsForCall)
}

func (fake *Os) LstatArgsForCall(i int) string {
	fake.lstatMutex.RLock()
	defer fake.lstatMutex.RUnlock()
	return fake.lstatArgsForCall[i].name
}

func (fake *Os) LstatReturns(result1 os.FileInfo, result2 error) {
	fake.LstatStub = nil
...
func (fake *Os) Getwd() (dir string, err error) {
...
func (fake *Os) GetwdCallCount() int {
	fake.getwdMutex.RLock()
	defer fake.getwdMutex.RUnlock()
	return len(fake.getwdArgsForCall)
}

func (fake *Os) GetwdReturns(result1 string, result2 error) {
	fake.GetwdStub = nil
...
func (fake *Os) MkdirAll(path string, perm os.FileMode) error {
...
func (fake *Os) MkdirAllCallCount() int {
	fake.mkdirAllMutex.RLock()
	defer fake.mkdirAllMutex.RUnlock()
	return len(fake.mkdirAllArgsForCall)
}

func (fake *Os) MkdirAllArgsForCall(i int) (string, os.FileMode) {
	fake.mkdirAllMutex.RLock()
	defer fake.mkdirAllMutex.RUnlock()
	return fake.mkdirAllArgsForCall[i].path, fake.mkdirAllArgsForCall[i].perm
}

func (fake *Os) MkdirAllReturns(result1 error) {
...
func (fake *Os) RemoveAll(path string) error {
...
func (fake *Os) IsPathSeparator(c uint8) bool {
...
func (fake *Os) Getgroups() ([]int, error) {
...
func (fake *Os) SameFile(fi1 os.FileInfo, fi2 os.FileInfo) bool {
...
func (fake *Os) Invocations() map[string][][]interface{} {
...
func (fake *Os) recordInvocation(key string, args []interface{}) {
